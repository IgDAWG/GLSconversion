...
Indicates whether DR haplotypes should be parsed for correct zygosity and unusual DR haplotypes flagged. Inconsistent loci will appear flagged in a separate column labeled 'DRB.HapFlag' and follow the genotype columns. The default behavior will flag unusual haplotypes.
...
foo.tab <- GLSconvert(Data=foo, Convert="Tab2GL", Output="R", DRB345.Check=FALSE)
