...
Indicates whether DR haplotypes should be parsed for correct zygosity and unusual DR haplotypes flagged. Inconsistent loci will appear flagged in a separate column labeled 'DRB.HapFlag' and follow the genotype columns. The default behavior will flag unusual haplotypes. HLA-DRB345 alleles without a respective HLA-DRB1 will remain unchanged and the flag will say 'ND' for not determined.
...
# Run the Tab2GL conversion on a text file outputting to a csv file
GLSconvert(Data=foo, Convert="Tab2GL", output="csv")

# Run the GL2Tab conversion on a data file without the full path name and with homozygous allele reduction of non-DRB345 alleles
