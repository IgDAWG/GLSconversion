...
Data can be output as either a text file (written as a tab or comma delimitted) or R object (sent to data frame). See Output parameters below. When running the GL2Tab conversion, all adjacent pairs of loci will include '_1' and '_2' to distinguish each chromosome.


## Parameters

`GLS.Convert(Data,Conv,Output="txt",System="HLA",HZY.Red=FALSE,DRB345.Flag=TRUE,Cores.Lim=1L)`
...
# Run the a Tab2GL conversion on an R object outputting to an R object
